...
PEGASUS_DEV( "SpeedStream USB 10/100 Ethernet", VENDOR_SIEMENS, 0x1001,
		DEFAULT_GPIO_RESET | PEGASUS_II )
PEGASUS_DEV( "Gile USB LAN Card UN-001", 0x8358, 0x7765,
		DEFAULT_GPIO_RESET | PEGASUS_II )
PEGASUS_DEV( "Gile USB LAN Card UN-001", 0x835a, 0x7765,
		DEFAULT_GPIO_RESET | PEGASUS_II )
PEGASUS_DEV( "Gile USB LAN Card UN-001", 0x835c, 0x7765,
		DEFAULT_GPIO_RESET | PEGASUS_II )
PEGASUS_DEV( "Gile USB LAN Card UN-001", 0x835e, 0x7765,
		DEFAULT_GPIO_RESET | PEGASUS_II )
